...
// Mark the execution in the "__spec__" value.
    ...
    branch_yes_3:;
    {
        ...
        tmp_mod_expr_right_1 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_4 = LOOKUP_ATTRIBUTE(tmp_expression_value_7, mod_consts[189]);
    ...
    branch_end_2:;
    {
        ...
        {
            PyObject *tmp_expression_value_8;
            tmp_expression_value_8 = PyObject_GetItem(locals_pandas$core$arrays$string_arrow$$$class__1_ArrowStringArray_63, mod_consts[39]);

            if (tmp_expression_value_8 == NULL) {
                if (CHECK_AND_CLEAR_KEY_ERROR_OCCURRED()) {
                    tmp_expression_value_8 = GET_STRING_DICT_VALUE(moduledict_pandas$core$arrays$string_arrow, (Nuitka_StringObject *)mod_consts[39]);
        ...
        }
        {
            ...
            tmp_defaults_7 = MAKE_TUPLE_EMPTY(4);
            {
                ...
                tmp_expression_value_9 = PyObject_GetItem(locals_pandas$core$arrays$string_arrow$$$class__1_ArrowStringArray_63, mod_consts[45]);

...
static PyObject *impl_scipy$fft$_fftlog$$$function__1_fht(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_46f31b390174a541f015741bc38ed514 = MAKE_FUNCTION_FRAME(codeobj_46f31b390174a541f015741bc38ed514, module_scipy$fft$_fftlog, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_46f31b390174a541f015741bc38ed514);
...
static PyObject *impl_scipy$fft$_fftlog$$$function__2_ifht(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_a2192c2e3f887f2f107f343388115b10)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_a2192c2e3f887f2f107f343388115b10 = MAKE_FUNCTION_FRAME(codeobj_a2192c2e3f887f2f107f343388115b10, module_scipy$fft$_fftlog, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_a2192c2e3f887f2f107f343388115b10);
...
static PyObject *impl_scipy$fft$_fftlog$$$function__3_fhtcoeff(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_669fa57b4821b2a7a36e1aa36801ab24)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_669fa57b4821b2a7a36e1aa36801ab24 = MAKE_FUNCTION_FRAME(codeobj_669fa57b4821b2a7a36e1aa36801ab24, module_scipy$fft$_fftlog, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_669fa57b4821b2a7a36e1aa36801ab24);
...
static PyObject *impl_scipy$fft$_fftlog$$$function__4_fhtoffset(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_8925682e26458a1881844fcfebc53f2e)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_8925682e26458a1881844fcfebc53f2e = MAKE_FUNCTION_FRAME(codeobj_8925682e26458a1881844fcfebc53f2e, module_scipy$fft$_fftlog, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_8925682e26458a1881844fcfebc53f2e);
...
static PyObject *impl_scipy$fft$_fftlog$$$function__5__fhtq(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_ca6fe7a1412f083fa4d110b0bc874aee)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_ca6fe7a1412f083fa4d110b0bc874aee = MAKE_FUNCTION_FRAME(codeobj_ca6fe7a1412f083fa4d110b0bc874aee, module_scipy$fft$_fftlog, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_ca6fe7a1412f083fa4d110b0bc874aee);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_e5fd6207346c2c5e4ab6cdb32efe8273);

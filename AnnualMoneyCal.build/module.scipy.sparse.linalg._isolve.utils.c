...
static PyObject *impl_scipy$sparse$linalg$_isolve$utils$$$function__1_coerce(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_9a9c406d5a810079865f8ce9ce0ef6c9 = MAKE_FUNCTION_FRAME(codeobj_9a9c406d5a810079865f8ce9ce0ef6c9, module_scipy$sparse$linalg$_isolve$utils, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_9a9c406d5a810079865f8ce9ce0ef6c9);
...
static PyObject *impl_scipy$sparse$linalg$_isolve$utils$$$function__3_make_system(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_846c6719ef4a127bdcd056b9e0e5bd62)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_846c6719ef4a127bdcd056b9e0e5bd62 = MAKE_FUNCTION_FRAME(codeobj_846c6719ef4a127bdcd056b9e0e5bd62, module_scipy$sparse$linalg$_isolve$utils, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_846c6719ef4a127bdcd056b9e0e5bd62);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_eb72a25a0c1802359684e0f10acaeaf1);

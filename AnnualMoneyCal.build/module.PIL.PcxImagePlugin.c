...
static PyObject *impl_PIL$PcxImagePlugin$$$function__2__open(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_9086548b528da01f8400e1e6fd4c9fbc)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_9086548b528da01f8400e1e6fd4c9fbc = MAKE_FUNCTION_FRAME(codeobj_9086548b528da01f8400e1e6fd4c9fbc, module_PIL$PcxImagePlugin, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_9086548b528da01f8400e1e6fd4c9fbc);
...
static PyObject *impl_PIL$PcxImagePlugin$$$function__3__save(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_c1a88c7e7b92b249ab6ad20747389e3a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_c1a88c7e7b92b249ab6ad20747389e3a = MAKE_FUNCTION_FRAME(codeobj_c1a88c7e7b92b249ab6ad20747389e3a, module_PIL$PcxImagePlugin, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_c1a88c7e7b92b249ab6ad20747389e3a);

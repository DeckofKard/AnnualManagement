...
// Mark the execution in the "__spec__" value.
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_defdd684f6b00e807b74e4424c0ba5ff);
    ...
    tmp_inplace_assign_subscr_3__value = NULL;
    {
        ...
        if (unlikely(tmp_add_expr_left_2 == NULL)) {
            tmp_add_expr_left_2 = GET_MODULE_VARIABLE_VALUE_FALLBACK(mod_consts[10]);
        }
    ...
    }
    {
        ...
        if (unlikely(tmp_sub_expr_left_1 == NULL)) {
            tmp_sub_expr_left_1 = GET_MODULE_VARIABLE_VALUE_FALLBACK(mod_consts[14]);
        }

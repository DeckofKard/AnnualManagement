...
static PyObject *impl_openpyxl$drawing$drawing$$$function__1___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_ce49ff77c6d301ef6cf998183efe05b0 = MAKE_FUNCTION_FRAME(codeobj_ce49ff77c6d301ef6cf998183efe05b0, module_openpyxl$drawing$drawing, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_ce49ff77c6d301ef6cf998183efe05b0);
...
static PyObject *impl_openpyxl$drawing$drawing$$$function__2_width(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_b104ed33a51393d0a200e4201dcd3585)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b104ed33a51393d0a200e4201dcd3585 = MAKE_FUNCTION_FRAME(codeobj_b104ed33a51393d0a200e4201dcd3585, module_openpyxl$drawing$drawing, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_b104ed33a51393d0a200e4201dcd3585);
...
static PyObject *impl_openpyxl$drawing$drawing$$$function__3_width(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_1a4ccf0a87c08bf29f9f3a681e998f36)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_1a4ccf0a87c08bf29f9f3a681e998f36 = MAKE_FUNCTION_FRAME(codeobj_1a4ccf0a87c08bf29f9f3a681e998f36, module_openpyxl$drawing$drawing, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_1a4ccf0a87c08bf29f9f3a681e998f36);
...
static PyObject *impl_openpyxl$drawing$drawing$$$function__4_height(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_78062df4bf67023d04f282f06b1112b2)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_78062df4bf67023d04f282f06b1112b2 = MAKE_FUNCTION_FRAME(codeobj_78062df4bf67023d04f282f06b1112b2, module_openpyxl$drawing$drawing, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_78062df4bf67023d04f282f06b1112b2);
...
static PyObject *impl_openpyxl$drawing$drawing$$$function__5_height(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_7c264423103d581c7416e33a87ddfd60)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_7c264423103d581c7416e33a87ddfd60 = MAKE_FUNCTION_FRAME(codeobj_7c264423103d581c7416e33a87ddfd60, module_openpyxl$drawing$drawing, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_7c264423103d581c7416e33a87ddfd60);
...
static PyObject *impl_openpyxl$drawing$drawing$$$function__6_set_dimension(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_3c08f025ec12b271eb850fd2e9340f52)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_3c08f025ec12b271eb850fd2e9340f52 = MAKE_FUNCTION_FRAME(codeobj_3c08f025ec12b271eb850fd2e9340f52, module_openpyxl$drawing$drawing, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_3c08f025ec12b271eb850fd2e9340f52);
...
static PyObject *impl_openpyxl$drawing$drawing$$$function__7_anchor(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_8e2e127fe3619e85b933735d2f088e55)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_8e2e127fe3619e85b933735d2f088e55 = MAKE_FUNCTION_FRAME(codeobj_8e2e127fe3619e85b933735d2f088e55, module_openpyxl$drawing$drawing, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_8e2e127fe3619e85b933735d2f088e55);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_1e2b6578951c258fac0f3b820c7f94ac);
    ...
    branch_end_1:;
    {
        ...
        frame_b1a0ccfde1b2482b2be26af7d099996c_2 = MAKE_CLASS_FRAME(codeobj_b1a0ccfde1b2482b2be26af7d099996c, module_openpyxl$drawing$drawing, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_b1a0ccfde1b2482b2be26af7d099996c_2);
        ...
        }
        {
            ...
            PyObject *tmp_called_value_3;
            PyObject *tmp_args_element_value_2;
            tmp_res = MAPPING_HAS_ITEM(locals_openpyxl$drawing$drawing$$$class__1_Drawing_9, mod_consts[63]);

...
static PyCodeObject *codeobj_cf7217ad439529825fb5f5ea4c796241;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_cf7217ad439529825fb5f5ea4c796241 = MAKE_CODE_OBJECT(module_filename_obj, 28, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[42], mod_consts[42], mod_consts[43], NULL, 1, 0, 0);
    codeobj_6f70c94052ed7ef755bf8226a23c4e51 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[44], mod_consts[44], NULL, NULL, 0, 0, 0);
    codeobj_d8377779d3f576fd51314af6bffd3321 = MAKE_CODE_OBJECT(module_filename_obj, 27, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[36], mod_consts[36], mod_consts[45], NULL, 2, 0, 0);
    codeobj_dc9daf0dfbf2bd2747ac30ed46a10223 = MAKE_CODE_OBJECT(module_filename_obj, 55, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[38], mod_consts[38], mod_consts[46], NULL, 1, 0, 0);
}
...
static PyObject *impl_PIL$GimpPaletteFile$$$function__1___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_cf7217ad439529825fb5f5ea4c796241_2;
    ...
    static struct Nuitka_FrameObject *cache_frame_cf7217ad439529825fb5f5ea4c796241_2 = NULL;
    ...
    // Framed code:
    {
        ...
        // Tried code:
        if (isFrameUnusable(cache_frame_cf7217ad439529825fb5f5ea4c796241_2)) {
            Py_XDECREF(cache_frame_cf7217ad439529825fb5f5ea4c796241_2);

#if _DEBUG_REFCOUNTS
            if (cache_frame_cf7217ad439529825fb5f5ea4c796241_2 == NULL) {
                count_active_frame_cache_instances += 1;
            } else {
                count_released_frame_cache_instances += 1;
            }
            count_allocated_frame_cache_instances += 1;
#endif
            cache_frame_cf7217ad439529825fb5f5ea4c796241_2 = MAKE_FUNCTION_FRAME(codeobj_cf7217ad439529825fb5f5ea4c796241, module_PIL$GimpPaletteFile, sizeof(void *));
#if _DEBUG_REFCOUNTS
        } else {
            count_hit_frame_cache_instances += 1;
#endif
        ...
        assert(cache_frame_cf7217ad439529825fb5f5ea4c796241_2->m_type_description == NULL);
        frame_cf7217ad439529825fb5f5ea4c796241_2 = cache_frame_cf7217ad439529825fb5f5ea4c796241_2;

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_cf7217ad439529825fb5f5ea4c796241_2);
        assert(Py_REFCNT(frame_cf7217ad439529825fb5f5ea4c796241_2) == 2);
        ...
        }
        {
            ...
            frame_cf7217ad439529825fb5f5ea4c796241_2->m_frame.f_lineno = 28;
        ...
        if (exception_tb == NULL) {
            exception_tb = MAKE_TRACEBACK(frame_cf7217ad439529825fb5f5ea4c796241_2, exception_lineno);
        } else if (exception_tb->tb_frame != &frame_cf7217ad439529825fb5f5ea4c796241_2->m_frame) {
            exception_tb = ADD_TRACEBACK(exception_tb, frame_cf7217ad439529825fb5f5ea4c796241_2, exception_lineno);
        }

        // Attaches locals to frame if any.
        Nuitka_Frame_AttachLocals(
            frame_cf7217ad439529825fb5f5ea4c796241_2,
            type_description_2,
            outline_0_var_i
        );
        ...
        if (frame_cf7217ad439529825fb5f5ea4c796241_2 == cache_frame_cf7217ad439529825fb5f5ea4c796241_2) {
#if _DEBUG_REFCOUNTS
            count_active_frame_cache_instances -= 1;
            count_released_frame_cache_instances += 1;
#endif
            Py_DECREF(cache_frame_cf7217ad439529825fb5f5ea4c796241_2);
            cache_frame_cf7217ad439529825fb5f5ea4c796241_2 = NULL;
        }

        assertFrameObject(frame_cf7217ad439529825fb5f5ea4c796241_2);
...
static PyObject *impl_PIL$GimpPaletteFile$$$function__2_getpalette(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_dc9daf0dfbf2bd2747ac30ed46a10223)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_dc9daf0dfbf2bd2747ac30ed46a10223 = MAKE_FUNCTION_FRAME(codeobj_dc9daf0dfbf2bd2747ac30ed46a10223, module_PIL$GimpPaletteFile, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_dc9daf0dfbf2bd2747ac30ed46a10223);

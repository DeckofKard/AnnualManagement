...
static PyCodeObject *codeobj_dc0986d8f123fd48720ac7ba47311f02;
static PyCodeObject *codeobj_f7fe5f873a2ca024579250101cff5ada;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[21]; CHECK_OBJECT(module_filename_obj);
    codeobj_dc0986d8f123fd48720ac7ba47311f02 = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[46], mod_consts[46], NULL, NULL, 0, 0, 0);
    codeobj_f7fe5f873a2ca024579250101cff5ada = MAKE_CODE_OBJECT(module_filename_obj, 8, CO_OPTIMIZED | CO_NEWLOCALS | CO_VARKEYWORDS, mod_consts[45], mod_consts[45], mod_consts[47], NULL, 2, 0, 0);
}
...
static PyObject *impl_charset_normalizer$legacy$$$function__1_detect(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_f7fe5f873a2ca024579250101cff5ada;
    ...
    int tmp_res;
    bool tmp_result;
    static struct Nuitka_FrameObject *cache_frame_f7fe5f873a2ca024579250101cff5ada = NULL;
    ...
    // Tried code:
    if (isFrameUnusable(cache_frame_f7fe5f873a2ca024579250101cff5ada)) {
        Py_XDECREF(cache_frame_f7fe5f873a2ca024579250101cff5ada);

#if _DEBUG_REFCOUNTS
        if (cache_frame_f7fe5f873a2ca024579250101cff5ada == NULL) {
...
#endif
        cache_frame_f7fe5f873a2ca024579250101cff5ada = MAKE_FUNCTION_FRAME(codeobj_f7fe5f873a2ca024579250101cff5ada, module_charset_normalizer$legacy, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    assert(cache_frame_f7fe5f873a2ca024579250101cff5ada->m_type_description == NULL);
    frame_f7fe5f873a2ca024579250101cff5ada = cache_frame_f7fe5f873a2ca024579250101cff5ada;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_f7fe5f873a2ca024579250101cff5ada);
    assert(Py_REFCNT(frame_f7fe5f873a2ca024579250101cff5ada) == 2);
    ...
    branch_yes_1:;
    {
        ...
        frame_f7fe5f873a2ca024579250101cff5ada->m_frame.f_lineno = 23;
    ...
    branch_yes_2:;
    {
        ...
        frame_f7fe5f873a2ca024579250101cff5ada->m_frame.f_lineno = 29;
        {
        ...
        frame_f7fe5f873a2ca024579250101cff5ada->m_frame.f_lineno = 28;
    ...
    branch_no_3:;
    {
        ...
        frame_f7fe5f873a2ca024579250101cff5ada->m_frame.f_lineno = 36;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_f7fe5f873a2ca024579250101cff5ada, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_f7fe5f873a2ca024579250101cff5ada->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_f7fe5f873a2ca024579250101cff5ada, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_f7fe5f873a2ca024579250101cff5ada,
        type_description_1,
        par_byte_str,
    ...
    if (frame_f7fe5f873a2ca024579250101cff5ada == cache_frame_f7fe5f873a2ca024579250101cff5ada) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_f7fe5f873a2ca024579250101cff5ada);
        cache_frame_f7fe5f873a2ca024579250101cff5ada = NULL;
    }

    assertFrameObject(frame_f7fe5f873a2ca024579250101cff5ada);
...
static PyObject *MAKE_FUNCTION_charset_normalizer$legacy$$$function__1_detect(PyObject *defaults, PyObject *annotations) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_f7fe5f873a2ca024579250101cff5ada,
        defaults,
#if PYTHON_VERSION >= 0x300
        NULL,
        annotations,
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_dc0986d8f123fd48720ac7ba47311f02;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    bool tmp_result;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    ...
    frame_dc0986d8f123fd48720ac7ba47311f02 = MAKE_MODULE_FRAME(codeobj_dc0986d8f123fd48720ac7ba47311f02, module_charset_normalizer$legacy);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_dc0986d8f123fd48720ac7ba47311f02);
    assert(Py_REFCNT(frame_dc0986d8f123fd48720ac7ba47311f02) == 2);
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        frame_dc0986d8f123fd48720ac7ba47311f02->m_frame.f_lineno = 2;
    ...
    }
    {
        ...
        frame_dc0986d8f123fd48720ac7ba47311f02->m_frame.f_lineno = 4;
    ...
    }
    {
        ...
        frame_dc0986d8f123fd48720ac7ba47311f02->m_frame.f_lineno = 5;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_dc0986d8f123fd48720ac7ba47311f02, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_dc0986d8f123fd48720ac7ba47311f02->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_dc0986d8f123fd48720ac7ba47311f02, exception_lineno);
    }



    assertFrameObject(frame_dc0986d8f123fd48720ac7ba47311f02);

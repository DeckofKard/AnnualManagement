...
static PyObject *impl_scipy$optimize$_trustregion_ncg$$$function__1__minimize_trust_ncg(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_41c4e6c77222fba7108c95673aaaf6af = MAKE_FUNCTION_FRAME(codeobj_41c4e6c77222fba7108c95673aaaf6af, module_scipy$optimize$_trustregion_ncg, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_41c4e6c77222fba7108c95673aaaf6af);
...
static PyObject *impl_scipy$optimize$_trustregion_ncg$$$function__2_solve(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_5c010d1090bea9ecb3e6aa642399d48c)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_5c010d1090bea9ecb3e6aa642399d48c = MAKE_FUNCTION_FRAME(codeobj_5c010d1090bea9ecb3e6aa642399d48c, module_scipy$optimize$_trustregion_ncg, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_5c010d1090bea9ecb3e6aa642399d48c);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_6d2d6df6caad91f612736ab6aa2e4973);
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_2)) {
            ...
            tmp_assign_source_9 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_2, mod_consts[41]);
        }
    ...
    branch_end_1:;
    {
        ...
        frame_df44ed17ed94260ef2d9acebb1e0daa8_2 = MAKE_CLASS_FRAME(codeobj_df44ed17ed94260ef2d9acebb1e0daa8, module_scipy$optimize$_trustregion_ncg, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_df44ed17ed94260ef2d9acebb1e0daa8_2);

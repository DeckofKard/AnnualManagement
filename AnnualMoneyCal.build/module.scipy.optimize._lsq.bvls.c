...
static PyObject *impl_scipy$optimize$_lsq$bvls$$$function__1_compute_kkt_optimality(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_5e4646a2e5fd113705aaa1853fa67404 = MAKE_FUNCTION_FRAME(codeobj_5e4646a2e5fd113705aaa1853fa67404, module_scipy$optimize$_lsq$bvls, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_5e4646a2e5fd113705aaa1853fa67404);
...
static PyObject *impl_scipy$optimize$_lsq$bvls$$$function__2_bvls(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_6d5dc8b6e0b04b933087bcacbab3816b);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_40a5bb0a1917ab16bf10f55229780f5e);

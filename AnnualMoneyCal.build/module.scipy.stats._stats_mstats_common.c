...
static PyObject *impl_scipy$stats$_stats_mstats_common$$$function__1_linregress(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_26293af291596bf916fdaf3e1483928c);
...
static PyObject *impl_scipy$stats$_stats_mstats_common$$$function__2_theilslopes(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_3be182bc0f6a8fd62d26c74d1d195748);
...
static PyObject *scipy$stats$_stats_mstats_common$$$function__2_theilslopes$$$genexpr__1_genexpr_context(struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(codeobj_b3fc5912dc67452e7f97dd1bf7ceea7a, module_scipy$stats$_stats_mstats_common, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *scipy$stats$_stats_mstats_common$$$function__2_theilslopes$$$genexpr__2_genexpr_context(struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(codeobj_2c42a42acbd0e2e9ae2516038d6fc35b, module_scipy$stats$_stats_mstats_common, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *impl_scipy$stats$_stats_mstats_common$$$function__3__find_repeats(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_fbe2a1a87175fd59585acea4f8fd9dca)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_fbe2a1a87175fd59585acea4f8fd9dca = MAKE_FUNCTION_FRAME(codeobj_fbe2a1a87175fd59585acea4f8fd9dca, module_scipy$stats$_stats_mstats_common, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_fbe2a1a87175fd59585acea4f8fd9dca);
...
static PyObject *impl_scipy$stats$_stats_mstats_common$$$function__4_siegelslopes(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_86d00bf9d01b20985f1706fb7c6edef2)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_86d00bf9d01b20985f1706fb7c6edef2 = MAKE_FUNCTION_FRAME(codeobj_86d00bf9d01b20985f1706fb7c6edef2, module_scipy$stats$_stats_mstats_common, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_86d00bf9d01b20985f1706fb7c6edef2);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_eef2f91a01a3c5d0be082ee00e8348f4);
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_3)) {
            ...
            tmp_assign_source_9 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_3, mod_consts[107]);
        }
    ...
    }
    {
        ...
        tmp_call_args_values_1 = DEEP_COPY_TUPLE_GUIDED(mod_consts[110], "ill");
        frame_eef2f91a01a3c5d0be082ee00e8348f4->m_frame.f_lineno = 11;
        tmp_assign_source_11 = CALL_FUNCTION_WITH_ARGS2_VECTORCALL(tmp_called_value_1, &PyTuple_GET_ITEM(tmp_call_args_values_1, 0), mod_consts[111]);

...
static PyObject *impl_scipy$optimize$_lsq$trf_linear$$$function__1_regularized_lsq_with_qr(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_32a1e9fdcf62582fb21846cbae0a601d = MAKE_FUNCTION_FRAME(codeobj_32a1e9fdcf62582fb21846cbae0a601d, module_scipy$optimize$_lsq$trf_linear, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_32a1e9fdcf62582fb21846cbae0a601d);
...
static PyObject *impl_scipy$optimize$_lsq$trf_linear$$$function__2_backtracking(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_cab8c06f981a1f7fed7055efedd1f0b3)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_cab8c06f981a1f7fed7055efedd1f0b3 = MAKE_FUNCTION_FRAME(codeobj_cab8c06f981a1f7fed7055efedd1f0b3, module_scipy$optimize$_lsq$trf_linear, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_cab8c06f981a1f7fed7055efedd1f0b3);
...
static PyObject *impl_scipy$optimize$_lsq$trf_linear$$$function__3_select_step(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_025d8ead6314594ea742a1687eb81fb8);
...
static PyObject *impl_scipy$optimize$_lsq$trf_linear$$$function__4_trf_linear(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_390ff0e3d7f03b6efd885e2ffd35373b);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_40f4fef132866e2b4893ab0f00b19fea);

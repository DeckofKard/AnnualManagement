...
static PyObject *impl_scipy$linalg$lapack$$$function__1_backtickrepl(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_10a71b870c4ade35a5d6b83a40691753 = MAKE_FUNCTION_FRAME(codeobj_10a71b870c4ade35a5d6b83a40691753, module_scipy$linalg$lapack, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_10a71b870c4ade35a5d6b83a40691753);
...
static PyObject *impl_scipy$linalg$lapack$$$function__2_get_lapack_funcs(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_74a4cce2dc1bbcb93587278a2ce8f47d)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_74a4cce2dc1bbcb93587278a2ce8f47d = MAKE_FUNCTION_FRAME(codeobj_74a4cce2dc1bbcb93587278a2ce8f47d, module_scipy$linalg$lapack, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_74a4cce2dc1bbcb93587278a2ce8f47d);
...
static PyObject *impl_scipy$linalg$lapack$$$function__3__compute_lwork(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_647aed7193eda54fd9741e777381a682)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_647aed7193eda54fd9741e777381a682 = MAKE_FUNCTION_FRAME(codeobj_647aed7193eda54fd9741e777381a682, module_scipy$linalg$lapack, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_647aed7193eda54fd9741e777381a682);
...
static PyObject *scipy$linalg$lapack$$$function__3__compute_lwork$$$genexpr__1_genexpr_context(struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(codeobj_1d71b1c476e5b77e7d571002ecb1123a, module_scipy$linalg$lapack, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *impl_scipy$linalg$lapack$$$function__4__check_work_float(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_7f611e536163844e01ee6c2ba99821e0)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_7f611e536163844e01ee6c2ba99821e0 = MAKE_FUNCTION_FRAME(codeobj_7f611e536163844e01ee6c2ba99821e0, module_scipy$linalg$lapack, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_7f611e536163844e01ee6c2ba99821e0);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_196ec8c5db2a57f1b2c107bd5fd72dfc);
    ...
    }
    {
        ...
        tmp_assign_source_19 = CALL_FUNCTION_WITH_POSARGS1(tmp_called_value_1, mod_consts[83]);
    ...
    }
    {
        ...
        tmp_assign_source_20 = CALL_FUNCTION_WITH_POSARGS1(tmp_called_value_2, mod_consts[85]);
    ...
    }
    {
        ...
        tmp_called_value_6 = LOOKUP_ATTRIBUTE(tmp_expression_value_7, mod_consts[104]);
        if (tmp_called_value_6 == NULL) {
            assert(ERROR_OCCURRED());
        ...
        tmp_assign_source_26 = LOOKUP_ATTRIBUTE(tmp_expression_value_6, mod_consts[106]);
    ...
    }
    {
        ...
        tmp_args_element_value_7 = LOOKUP_ATTRIBUTE(tmp_expression_value_11, mod_consts[107]);
        if (tmp_args_element_value_7 == NULL) {
            assert(ERROR_OCCURRED());
        ...
        tmp_assign_source_27 = LOOKUP_ATTRIBUTE(tmp_expression_value_9, mod_consts[106]);

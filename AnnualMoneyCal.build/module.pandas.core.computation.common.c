...
static PyObject *impl_pandas$core$computation$common$$$function__1_ensure_decoded(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_e642e1b224a2da581507b1cb369e0677 = MAKE_FUNCTION_FRAME(codeobj_e642e1b224a2da581507b1cb369e0677, module_pandas$core$computation$common, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_e642e1b224a2da581507b1cb369e0677);
...
static PyObject *impl_pandas$core$computation$common$$$function__2_result_type_many(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_eebb7a097fc399431720c6af15aa0368)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_eebb7a097fc399431720c6af15aa0368 = MAKE_FUNCTION_FRAME(codeobj_eebb7a097fc399431720c6af15aa0368, module_pandas$core$computation$common, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_eebb7a097fc399431720c6af15aa0368);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_70e9d0a608ce3501b885343c41cf1fa4);

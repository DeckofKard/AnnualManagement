...
// Mark the execution in the "__spec__" value.
    ...
    branch_end_1:;
    {
        ...
        tmp_add_expr_left_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_6, mod_consts[251]);
        if (tmp_add_expr_left_1 == NULL) {
            assert(ERROR_OCCURRED());
        ...
        tmp_add_expr_right_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_8, mod_consts[258]);
        if (tmp_add_expr_right_2 == NULL) {
            assert(ERROR_OCCURRED());
        ...
        }
        {
            ...
            tmp_expression_value_17 = PyObject_GetItem(locals_pandas$core$indexes$datetimes$$$class__1_DatetimeIndex_129, mod_consts[241]);

            if (tmp_expression_value_17 == NULL) {
                if (CHECK_AND_CLEAR_KEY_ERROR_OCCURRED()) {
                    tmp_expression_value_17 = GET_STRING_DICT_VALUE(moduledict_pandas$core$indexes$datetimes, (Nuitka_StringObject *)mod_consts[241]);

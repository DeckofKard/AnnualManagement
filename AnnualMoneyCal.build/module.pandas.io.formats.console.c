...
static PyObject *impl_pandas$io$formats$console$$$function__1_get_console_size(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_5416c66e53a855b1699c6ceb4de17286 = MAKE_FUNCTION_FRAME(codeobj_5416c66e53a855b1699c6ceb4de17286, module_pandas$io$formats$console, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_5416c66e53a855b1699c6ceb4de17286);
...
static PyObject *impl_pandas$io$formats$console$$$function__2_in_interactive_session(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_393584fe7a13461fc3f5dde529cfb81a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_393584fe7a13461fc3f5dde529cfb81a = MAKE_FUNCTION_FRAME(codeobj_393584fe7a13461fc3f5dde529cfb81a, module_pandas$io$formats$console, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_393584fe7a13461fc3f5dde529cfb81a);
...
static PyObject *impl_pandas$io$formats$console$$$function__2_in_interactive_session$$$function__1_check_main(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_a22b70cb63dd92ba96e8a3211f4fde3b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_a22b70cb63dd92ba96e8a3211f4fde3b = MAKE_FUNCTION_FRAME(codeobj_a22b70cb63dd92ba96e8a3211f4fde3b, module_pandas$io$formats$console, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_a22b70cb63dd92ba96e8a3211f4fde3b);
...
static PyObject *impl_pandas$io$formats$console$$$function__3_in_ipython_frontend(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_b8c784561d46bef241552bdb17e1a099)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b8c784561d46bef241552bdb17e1a099 = MAKE_FUNCTION_FRAME(codeobj_b8c784561d46bef241552bdb17e1a099, module_pandas$io$formats$console, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_b8c784561d46bef241552bdb17e1a099);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_92833ecf72471877c902415e7c39fc7e);

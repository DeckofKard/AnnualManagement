...
static PyObject *impl_openpyxl$comments$comments$$$function__1___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_95ff149fce669252daace4babf2a920a = MAKE_FUNCTION_FRAME(codeobj_95ff149fce669252daace4babf2a920a, module_openpyxl$comments$comments, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_95ff149fce669252daace4babf2a920a);
...
static PyObject *impl_openpyxl$comments$comments$$$function__2_parent(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_2389b11911eda443e75a1d6d8e696a3e)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2389b11911eda443e75a1d6d8e696a3e = MAKE_FUNCTION_FRAME(codeobj_2389b11911eda443e75a1d6d8e696a3e, module_openpyxl$comments$comments, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_2389b11911eda443e75a1d6d8e696a3e);
...
static PyObject *impl_openpyxl$comments$comments$$$function__3___eq__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_00431a1b275c9ca600c508104c6a7166)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_00431a1b275c9ca600c508104c6a7166 = MAKE_FUNCTION_FRAME(codeobj_00431a1b275c9ca600c508104c6a7166, module_openpyxl$comments$comments, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_00431a1b275c9ca600c508104c6a7166);
...
static PyObject *impl_openpyxl$comments$comments$$$function__4___repr__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_436d4d5dc10f2d0f4062c1101bc5b911)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_436d4d5dc10f2d0f4062c1101bc5b911 = MAKE_FUNCTION_FRAME(codeobj_436d4d5dc10f2d0f4062c1101bc5b911, module_openpyxl$comments$comments, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_436d4d5dc10f2d0f4062c1101bc5b911);
...
static PyObject *impl_openpyxl$comments$comments$$$function__5___copy__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_d73ed9d8389cefb3cb1bc2085191ee4b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_d73ed9d8389cefb3cb1bc2085191ee4b = MAKE_FUNCTION_FRAME(codeobj_d73ed9d8389cefb3cb1bc2085191ee4b, module_openpyxl$comments$comments, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_d73ed9d8389cefb3cb1bc2085191ee4b);
...
static PyObject *impl_openpyxl$comments$comments$$$function__6_bind(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_83f0b64ffef531825ecbcc470777c2e8)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_83f0b64ffef531825ecbcc470777c2e8 = MAKE_FUNCTION_FRAME(codeobj_83f0b64ffef531825ecbcc470777c2e8, module_openpyxl$comments$comments, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_83f0b64ffef531825ecbcc470777c2e8);
...
static PyObject *impl_openpyxl$comments$comments$$$function__7_unbind(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_c2507a9c2001fefd5270ee0e1bda05a9)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_c2507a9c2001fefd5270ee0e1bda05a9 = MAKE_FUNCTION_FRAME(codeobj_c2507a9c2001fefd5270ee0e1bda05a9, module_openpyxl$comments$comments, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_c2507a9c2001fefd5270ee0e1bda05a9);
...
static PyObject *impl_openpyxl$comments$comments$$$function__8_text(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_d52cba146f68ec7babf25b9f33a30d1a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_d52cba146f68ec7babf25b9f33a30d1a = MAKE_FUNCTION_FRAME(codeobj_d52cba146f68ec7babf25b9f33a30d1a, module_openpyxl$comments$comments, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_d52cba146f68ec7babf25b9f33a30d1a);
...
static PyObject *impl_openpyxl$comments$comments$$$function__9_text(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_f01e6d5bfbd73d53c0e48b100e02e3b8)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_f01e6d5bfbd73d53c0e48b100e02e3b8 = MAKE_FUNCTION_FRAME(codeobj_f01e6d5bfbd73d53c0e48b100e02e3b8, module_openpyxl$comments$comments, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_f01e6d5bfbd73d53c0e48b100e02e3b8);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_69b501aad47ce63de69aadda6473ed0a);
    ...
    branch_end_1:;
    {
        ...
        frame_bec0c31edbeff530e5249b98be6a8ecf_2 = MAKE_CLASS_FRAME(codeobj_bec0c31edbeff530e5249b98be6a8ecf, module_openpyxl$comments$comments, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_bec0c31edbeff530e5249b98be6a8ecf_2);
        ...
        }
        {
            ...
            PyObject *tmp_args_element_value_2;
            tmp_res = MAPPING_HAS_ITEM(locals_openpyxl$comments$comments$$$class__1_Comment_4, mod_consts[35]);
        ...
        }
        {
            ...
            tmp_dictset_value = CALL_METHOD_WITH_SINGLE_ARG(tmp_called_instance_1, mod_consts[49], tmp_args_element_value_5);

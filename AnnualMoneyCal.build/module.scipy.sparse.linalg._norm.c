...
static PyObject *impl_scipy$sparse$linalg$_norm$$$function__1__sparse_frobenius_norm(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_3d60372c0c83f7ec73ffa26f4159a1ce = MAKE_FUNCTION_FRAME(codeobj_3d60372c0c83f7ec73ffa26f4159a1ce, module_scipy$sparse$linalg$_norm, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_3d60372c0c83f7ec73ffa26f4159a1ce);
...
static PyObject *impl_scipy$sparse$linalg$_norm$$$function__2_norm(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_1d013a7b26a1c35205e0ef484326664b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_1d013a7b26a1c35205e0ef484326664b = MAKE_FUNCTION_FRAME(codeobj_1d013a7b26a1c35205e0ef484326664b, module_scipy$sparse$linalg$_norm, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_1d013a7b26a1c35205e0ef484326664b);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_25888bcb82cae57f14adff40dc1a7f65);
